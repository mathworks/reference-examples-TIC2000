...
PAGE 1 :
    EEPROM_Bank            : origin = 0x0BE000, length = 0x00008	/* on-chip Flash */
    EEPROM_Page            : origin = 0x0BE008, length = 0x00008	/* on-chip Flash */
    EEPROM_Flash           : origin = 0x0BE010, length = 0x00010	/* on-chip Flash */
	FLASHN                 : origin = 0x0BE020, length = 0x001FDF	/* on-chip Flash */
...
SECTIONS
{
   ...
   /* Allocate program areas: */
       EEPROMdata        : LOAD = EEPROM_Flash,
                          ...
                          PAGE = 1, ALIGN(8)
       EEPROM_Bank_Flash : LOAD = EEPROM_Bank,
                          PAGE = 1, ALIGN(8)
       EEPROM_Page_Flash : LOAD = EEPROM_Page,
                          PAGE = 1, ALIGN(8)
